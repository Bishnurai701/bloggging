...
public class PostController {
	...
	public ResponseEntity<List<PostDto>>  getPostsBuUser(@PathVariable Integer userId)
	{
	...
	public ResponseEntity<List<PostDto>>  getPostsBuCategory(@PathVariable Integer categoryId)
	{
	...
	{
		InputStream resouce=this.fileService.getResource(path, imageName);
